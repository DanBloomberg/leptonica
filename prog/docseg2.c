...
static char  mainName[] = "docseg2";

    if (argc != 4)
	exit(ERROR_INT(" Syntax:  docseg2 filein thresh fileout",
                       mainName, 1));
...
#if 1
    pixDisplay(pixmask4, 100, 100);
    pixDisplay(pixseed4, 400, 100);
    pixDisplay(pixd4, 700, 100);
    pixDisplay(pixb, 1000, 100);
#endif
