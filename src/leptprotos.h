...
LEPT_DLL extern PIX * pixCleanUnderTransparency ( PIX *pixs, l_int32 debugflag );
...
LEPT_DLL extern SARRAY * getNumberedPathnamesInDirectory ( const char *dirname, l_int32 numpre, l_int32 numpost, l_int32 maxnum );
