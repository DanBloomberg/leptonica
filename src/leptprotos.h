...
extern l_int32 pixGetForegroundGrayMap ( PIX *pixs, PIX *pixim, l_int32 sx, l_int32 sy, l_int32 thresh, PIX **ppixd );
...
extern PTA * ptaGeneratePolyline ( PTA *ptas, l_int32 width, l_int32 closeflag, l_int32 removedups );
...
extern PIX * pixDistanceFunction ( PIX *pixs, l_int32 connectivity, l_int32 outdepth );
