...
extern PIX * pixWindowedMean ( PIX *pixs, l_int32 size );
extern PIX * pixWindowedMeanSquare ( PIX *pixs, l_int32 size );
...
extern BOXAA * boxaaReadVersion2 ( const char *filename );
extern BOXAA * boxaaReadStreamVersion2 ( FILE *fp );
...
extern BOX * pixSeedfillBB ( PIX *pixs, L_STACK *lstack, l_int32 x, l_int32 y, l_int32 connectivity );
extern BOX * pixSeedfill4BB ( PIX *pixs, L_STACK *lstack, l_int32 x, l_int32 y );
extern BOX * pixSeedfill8BB ( PIX *pixs, L_STACK *lstack, l_int32 x, l_int32 y );
extern l_int32 pixSeedfill ( PIX *pixs, L_STACK *lstack, l_int32 x, l_int32 y, l_int32 connectivity );
extern l_int32 pixSeedfill4 ( PIX *pixs, L_STACK *lstack, l_int32 x, l_int32 y );
extern l_int32 pixSeedfill8 ( PIX *pixs, L_STACK *lstack, l_int32 x, l_int32 y );
...
extern PIX * pixGrayQuantizeFromHisto ( PIX *pixd, PIX *pixs, PIX *pixm, l_float32 minfract, l_int32 maxsize );
...
extern l_int32 lheapExtendArray ( L_HEAP *lh );
...
extern l_int32 numaCopyXParameters ( NUMA *nad, NUMA *nas );
...
extern l_int32 pixGetResolution ( PIX *pix, l_uint32 *pxres, l_uint32 *pyres );
extern l_int32 pixSetResolution ( PIX *pix, l_uint32 xres, l_uint32 yres );
...
extern l_int32 pixSetBlackOrWhite ( PIX *pixs, l_int32 incolor );
...
extern void ptraDestroy ( L_PTRA **ppa, l_int32 freeflag );
extern l_int32 ptraAdd ( L_PTRA *pa, void *item );
extern l_int32 ptraExtendArray ( L_PTRA *pa );
extern l_int32 ptraInsert ( L_PTRA *pa, l_int32 index, void *item, l_int32 shiftflag );
extern void * ptraGetHandle ( L_PTRA *pa, l_int32 index );
...
extern void ptraaDestroy ( L_PTRAA **ppaa, l_int32 freeflag );
...
extern l_int32 lqueueExtendArray ( L_QUEUE *lq );
...
extern l_int32 lstackExtendArray ( L_STACK *lstack );
