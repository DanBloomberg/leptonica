...
LEPT_DLL extern BMF * bmfCreate ( const char *dir, l_int32 size );
LEPT_DLL extern void bmfDestroy ( BMF **pbmf );
LEPT_DLL extern PIX * bmfGetPix ( BMF *bmf, char chr );
LEPT_DLL extern l_int32 bmfGetWidth ( BMF *bmf, char chr, l_int32 *pw );
LEPT_DLL extern l_int32 bmfGetBaseline ( BMF *bmf, char chr, l_int32 *pbaseline );
...
LEPT_DLL extern PIX * pixMedianCutQuantGeneral ( PIX *pixs, l_int32 ditherflag, l_int32 outdepth, l_int32 maxcolors, l_int32 sigbits, l_int32 maxsub );
...
LEPT_DLL extern NUMA * pixCompareRankDifference ( PIX *pix1, PIX *pix2 );
...
LEPT_DLL extern PIX * pixDisplayPta ( PIX *pixs, PTA *pta );
...
LEPT_DLL extern NUMA * numaCreateFromIArray ( l_int32 *array, l_int32 size );
...
LEPT_DLL extern l_int32 pixSerializeToMemory ( PIX *pixs, l_uint32 **pdata, l_int32 *pnbytes );
LEPT_DLL extern PIX * pixDeserializeFromMemory ( l_uint32 *data, l_int32 nbytes );
...
LEPT_DLL extern PIXACC * pixaccCreate ( l_int32 w, l_int32 h, l_int32 subflag );
...
LEPT_DLL extern PIX * pixConvertGrayToSubpixelRGB ( PIX *pixs, l_float32 scalefactor, l_int32 direction, l_int32 order );
...
LEPT_DLL extern l_int32 readHeaderPng ( const char *filename, l_int32 *pwidth, l_int32 *pheight, l_int32 *pbpc, l_int32 *pcpp, l_int32 *piscmap );
LEPT_DLL extern l_int32 freadHeaderPng ( FILE *fp, l_int32 *pwidth, l_int32 *pheight, l_int32 *pbpc, l_int32 *pcpp, l_int32 *piscmap );
LEPT_DLL extern l_int32 sreadHeaderPng ( const l_uint8 *data, l_int32 *pwidth, l_int32 *pheight, l_int32 *pbpc, l_int32 *pcpp, l_int32 *piscmap );
...
LEPT_DLL extern l_int32 freadHeaderPnm ( FILE *fp, PIX **ppix, l_int32 *pwidth, l_int32 *pheight, l_int32 *pdepth, l_int32 *ptype, l_int32 *pbpc, l_int32 *pcpp );
...
LEPT_DLL extern l_int32 sreadHeaderPnm ( const l_uint8 *cdata, size_t size, l_int32 *pwidth, l_int32 *pheight, l_int32 *pdepth, l_int32 *ptype, l_int32 *pbpc, l_int32 *pcpp );
...
LEPT_DLL extern l_int32 convertSegmentedPagesToPS ( const char *pagedir, const char *maskdir, l_float32 textscale, l_float32 imagescale, l_int32 threshold, l_int32 numpre, l_int32 numpost, const char *fileout );
...
LEPT_DLL extern NUMA * sarrayFindMaskAndPagePairings ( SARRAY *sapage, SARRAY *samask, l_int32 numpre, l_int32 numpost, l_int32 maxnum );
...
LEPT_DLL extern char * generateJpegPS ( const char *filein, char *data85, l_int32 w, l_int32 h, l_int32 bps, l_int32 spp, l_float32 xpt, l_float32 ypt, l_float32 wpt, l_float32 hpt, l_int32 bbflag, l_int32 pageno, l_int32 endpage );
...
LEPT_DLL extern char * generateTiffG4PS ( const char *filein, char *data85, l_int32 w, l_int32 h, l_float32 xpt, l_float32 ypt, l_float32 wpt, l_float32 hpt, l_int32 bbflag, l_int32 minisblack, l_int32 maskflag, l_int32 pageno, l_int32 endpage );
...
LEPT_DLL extern char * generateFlatePS ( const char *filein, char *data85, char *cmapdata85, l_int32 ncolors, l_int32 w, l_int32 h, l_int32 bps, l_int32 spp, l_float32 xpt, l_float32 ypt, l_float32 wpt, l_float32 hpt, l_int32 bbflag, l_int32 pageno, l_int32 endpage );
...
LEPT_DLL extern BOX * ptaGetExtent ( PTA *pta );
...
LEPT_DLL extern PIX * pixAddSingleTextblock ( PIX *pixs, BMF *bmf, const char *textstr, l_uint32 val, l_int32 location, l_int32 *poverflow );
LEPT_DLL extern l_int32 pixSetTextblock ( PIX *pixs, BMF *bmf, const char *textstr, l_uint32 val, l_int32 x0, l_int32 y0, l_int32 wtext, l_int32 firstindent, l_int32 *poverflow );
LEPT_DLL extern l_int32 pixSetTextline ( PIX *pixs, BMF *bmf, const char *textstr, l_uint32 val, l_int32 x0, l_int32 y0, l_int32 *pwidth, l_int32 *poverflow );
LEPT_DLL extern SARRAY * bmfGetLineStrings ( BMF *bmf, const char *textstr, l_int32 maxw, l_int32 firstindent, l_int32 *ph );
LEPT_DLL extern NUMA * bmfGetWordWidths ( BMF *bmf, const char *textstr, SARRAY *sa );
LEPT_DLL extern l_int32 bmfGetStringWidth ( BMF *bmf, const char *textstr, l_int32 *pw );
...
LEPT_DLL extern l_int32 readHeaderTiff ( const char *filename, l_int32 n, l_int32 *pwidth, l_int32 *pheight, l_int32 *pbps, l_int32 *pspp, l_int32 *pres, l_int32 *pcmap );
LEPT_DLL extern l_int32 freadHeaderTiff ( FILE *fp, l_int32 n, l_int32 *pwidth, l_int32 *pheight, l_int32 *pbps, l_int32 *pspp, l_int32 *pres, l_int32 *pcmap );
LEPT_DLL extern l_int32 readHeaderMemTiff ( const l_uint8 *cdata, size_t size, l_int32 n, l_int32 *pwidth, l_int32 *pheight, l_int32 *pbps, l_int32 *pspp, l_int32 *pres, l_int32 *pcmap );
...
LEPT_DLL extern char * genTempFilename ( const char *dir, const char *extension );
