...
extern PIX * pixReadMemBmp ( const l_uint8 *data, size_t size );
...
extern PIX * pixFewColorsOctcubeQuant ( PIX *pixs, l_int32 level, NUMA *na, l_int32 ncolors, l_int32 *pnerrors );
...
extern PIX * pixConvolve ( PIX *pixs, L_KERNEL *kel );
...
extern l_int32 pixCorrelationScoreThresholded ( PIX *pix1, PIX *pix2, l_int32 area1, l_int32 area2, l_float32 delx, l_float32 dely, l_int32 *tab, l_int32 *downcount, l_float32 score_threshold );
extern l_float32 pixCorrelationScoreSimple ( PIX *pix1, PIX *pix2, l_int32 area1, l_int32 area2, l_float32 delx, l_float32 dely, l_int32 *tab );
...
extern l_int32 kernelGetElement ( L_KERNEL *kel, l_int32 row, l_int32 col, l_int32 *pval );
extern l_int32 kernelSetElement ( L_KERNEL *kel, l_int32 row, l_int32 col, l_int32 val );
...
extern l_int32 kernelGetNorm ( L_KERNEL *kel, l_float32 *pnorm );
...
extern NUMA * parseStringForInts ( const char *str, const char *seps );
...
extern NUMA * numaArithOp ( NUMA *na1, NUMA *na2, l_int32 op );
...
extern l_int32 numaSplitDistribution ( NUMA *na, l_float32 estfract, l_int32 *psplitindex, l_float32 *pave1, l_float32 *pave2, l_float32 *pnum1, l_float32 *pnum2, l_int32 debugflag );
...
extern l_int32 numaEvalBestHaarParameters ( NUMA *nas, l_int32 nwidth, l_int32 nshift, l_float32 minwidth, l_float32 maxwidth, l_float32 *pbestwidth, l_float32 *pbestshift, l_float32 *pbestscore );
extern l_int32 numaEvalHaarSum ( NUMA *nas, l_float32 width, l_float32 shift, l_float32 *pscore );
...
extern l_int32 pixSplitDistributionFgBg ( PIX *pixs, l_float32 estfract, l_int32 factor, l_int32 *pthresh, l_int32 *pfgval, l_int32 *pbgval );
...
extern PIX * pixReadMemPng ( const l_uint8 *data, size_t size );
...
extern l_int32 readHeaderMemTiff ( const l_uint8 *cdata, size_t size, l_int32 *pwidth, l_int32 *pheight, l_int32 *pbps, l_int32 *pspp, l_int32 *pres, l_int32 *pcmap );
