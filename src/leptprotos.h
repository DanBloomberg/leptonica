...
LEPT_DLL extern l_int32 pixGetRankColorArray ( PIX *pixs, l_int32 nbins, l_int32 factor, l_uint32 **pcarray, l_int32 debugflag );
...
LEPT_DLL extern char * genTempFilename ( const char *dir, const char *segment, const char *extension );
