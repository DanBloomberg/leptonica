/*
 *  This file was autogen'd by xtractprotos, v. 1.2
 */
#ifdef __cplusplus
extern "C" {
#endif  /* __cplusplus */
...
extern PIX * pixReadMemBmp ( const l_uint8 *cdata, l_uint32 size );
extern l_int32 pixWriteMemBmp ( l_uint8 **pdata, l_uint32 *psize, PIX *pix );
...
extern BOX * pixSeedfillBB ( PIX *pixs, STACK *stack, l_int32 x, l_int32 y, l_int32 connectivity );
extern BOX * pixSeedfill4BB ( PIX *pixs, STACK *stack, l_int32 x, l_int32 y );
extern BOX * pixSeedfill8BB ( PIX *pixs, STACK *stack, l_int32 x, l_int32 y );
extern l_int32 pixSeedfill ( PIX *pixs, STACK *stack, l_int32 x, l_int32 y, l_int32 connectivity );
extern l_int32 pixSeedfill4 ( PIX *pixs, STACK *stack, l_int32 x, l_int32 y );
extern l_int32 pixSeedfill8 ( PIX *pixs, STACK *stack, l_int32 x, l_int32 y );
...
extern PIX * pixSobelEdgeFilter ( PIX *pixs );
...
extern PIX * pixReadMemGif ( const l_uint8 *cdata, l_uint32 size );
...
extern PIX * pixReadMemJpeg ( const l_uint8 *cdata, l_uint32 size, l_int32 cmflag, l_int32 reduction, l_int32 *pnwarn, l_int32 hint );
extern l_int32 pixWriteMemJpeg ( l_uint8 **pdata, l_uint32 *psize, PIX *pix, l_int32 quality, l_int32 progressive );
...
extern PIX * pixReadMemPng ( const l_uint8 *cdata, l_uint32 size );
extern l_int32 pixWriteMemPng ( l_uint8 **pdata, l_uint32 *psize, PIX *pix, l_float32 gamma );
...
extern PIX * pixReadMemPnm ( const l_uint8 *cdata, l_uint32 size );
extern l_int32 pixWriteMemPnm ( l_uint8 **pdata, l_uint32 *psize, PIX *pix );
...
extern l_int32 pixWriteMemPS ( l_uint8 **pdata, l_uint32 *psize, PIX *pix, BOX *box, l_int32 res, l_float32 scale );
...
extern PIX * pixReadMem ( const l_uint8 *data, l_uint32 size );
...
extern l_int32 pixWriteMem ( l_uint8 **pdata, l_uint32 *psize, PIX *pix, l_int32 format );
